...
# 1. Initialize Session States (ဒုတိယကုဒ်ပိုင်းပါဝင်မှု)
...
# Sample Inventory & Sales State initialization for global use
  ...
  with st.form("login_form"):
    ...
    if submit_button:
      ...
      if username_input == "admin" and password_input == "123":
        ...
        # Admin အတွက် လုပ်ပိုင်ခွင့်အပြည့်အစုံ Session State ထဲ သိမ်းရန်
        st.session_state.permissions = {
            "sales": True,
            "inventory_view": True,
            "inventory_edit": True,
        ...
        try:
          ...
          if user_doc.exists:
            ...
            if (
              ...
              # Staff ၏ သတ်မှတ်ထားသော Permissions များကို Session State ထဲ သိမ်းရန်
...
# --- 3. SIDEBAR NAVIGATION (Permissions အလိုက် စစ်ထုတ်ခြင်း) ---
st.sidebar.success(
